...
IMAGE_SIZE = 128
BATCH_SIZE = 32
DEFAULT_WEIGHTS = "botanist_basic_cnn_best.pth"
FILE_COL = "FileName"
LABEL_COL = "Label"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run test predictions with the Basic CNN Botanist model."
    )
    parser.add_argument(
        "--input",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Path to the trained Basic CNN checkpoint.",
    )
    parser.add_argument(
        "--output",
        type=str,
        default="basic_cnn_test_predictions.csv",
